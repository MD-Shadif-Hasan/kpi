  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-inline-flex" href="index.html"><img class="d-inline-block" src="{{asset('frontend/assets/img/gallery/logo.svg')}}" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">foodwaGon</span></a>
      ...
      <section class="py-5 overflow-hidden bg-primary" id="home">
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 col-lg-6 order-0 order-md-1 mt-8 mt-md-0"><a class="img-landing-banner" href="#!"><img class="img-fluid" src="{{asset('frontend/assets/img/gallery/hero-header.png')}}" alt="hero-header" /></a></div>
            ...
            <div class="col-xl-9">
              ...
              <div class="row">
                <div class="col-sm-6 col-md-3 mb-6">
                  <div class="text-center"><img class="shadow-icon" src="{{asset('frontend/assets/img/gallery/location.png')}}" height="112" alt="..." />
                    <h5 class="mt-4 fw-bold">Select location</h5>
                    <p class="mb-md-0">Choose the location where your food will be delivered.</p>
                  </div>
                </div>
                <div class="col-sm-6 col-md-3 mb-6">
                  <div class="text-center"><img class="shadow-icon" src="{{asset('frontend/assets/img/gallery/order.png')}}" height="112" alt="..." />
                    <h5 class="mt-4 fw-bold">Choose order</h5>
                    <p class="mb-md-0">Check over hundreds of menus to pick your favorite food</p>
                  </div>
                </div>
                <div class="col-sm-6 col-md-3 mb-6">
                  <div class="text-center"><img class="shadow-icon" src="{{asset('frontend/assets/img/gallery/pay.png')}}" height="112" alt="..." />
                    <h5 class="mt-4 fw-bold">Pay advanced</h5>
                    <p class="mb-md-0">It's quick, safe, and simple. Select several methods of payment</p>
                  </div>
                </div>
                <div class="col-sm-6 col-md-3 mb-6">
                  <div class="text-center"><img class="shadow-icon" src="{{asset('frontend/assets/img/gallery/meals.png')}}" height="112" alt="..." />
              ...
              <div class="row">
                    @foreach($products as $data)
                      <div class="col-lg-3 col-md-6 ">
                        <div class="food_img"><img src="{{asset('storage/'.$data->image)}}" alt=""></div>
                        <div class="food_name"><h5>{{$data->name}}</h5></div>
                        <div class="food_price"><h5>{{$data->price}}$</h5></div>
                        <div class="food_btn"><button type="button" class="btn btn-primary">Add to cart</button></div>
                  </div>
                      @endforeach
                      </div>
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100 align-items-center">
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-circle"><img class="img-fluid rounded-circle h-100" src="{{asset('frontend/assets/img/gallery/search-pizza.png')}}" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-circle"><img class="img-fluid rounded-circle h-100" src="{{asset('frontend/assets/img/gallery/burger.png')}}" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-circle"><img class="img-fluid rounded-circle h-100" src="{{asset('frontend/assets/img/gallery/noodles.png')}}" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-circle"><img class="img-fluid rounded-circle h-100" src="{{asset('frontend/assets/img/gallery/sub-sandwich.png')}}" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-circle"><img class="img-fluid rounded-circle h-100" src="{{asset('frontend/assets/img/gallery/chowmein.png')}}" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-circle"><img class="img-fluid rounded-circle h-100" src="{{asset('frontend/assets/img/gallery/steak.png')}}" alt="..." />
                          <div class="card-body ps-0">
      ...
      <section>
        ...
        <div class="container">
              ...
              <div class="card card-span shadow-warning" style="border-radius: 35px;">
                <div class="card-body py-5">
                  <div class="row justify-content-evenly">
                    <div class="col-md-3">
                      <div class="d-flex d-md-block d-xl-flex justify-content-evenly justify-content-lg-between"><img src="{{asset('frontend/assets/img/icons/discounts.png')}}" width="100" alt="..." />
                    ...
                    <div class="col-md-3 hr-vertical">
                      <div class="d-flex d-md-block d-xl-flex justify-content-evenly justify-content-lg-between"><img src="{{asset('frontend/assets/img/icons/live-tracking.png')}}" width="100" alt="..." />
                        <div class="d-flex d-lg-block d-xl-flex flex-center">
                    ...
                    <div class="col-md-3 hr-vertical">
                      <div class="d-flex d-md-block d-xl-flex justify-content-evenly justify-content-lg-between"><img src="{{asset('frontend/assets/img/icons/quick-delivery.png')}}" width="100" alt="..." />
                        <div class="d-flex d-lg-block d-xl-flex flex-center">
          ...
          <div class="row flex-center mt-md-8">
            <div class="col-lg-5 d-none d-lg-block" style="margin-bottom: -122px;"> <img class="w-100" src="{{asset('frontend/assets/img/gallery/phone-cta-one.png')}}" alt="..." /></div>
